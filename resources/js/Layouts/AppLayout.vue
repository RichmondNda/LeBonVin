                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <jet-nav-link :href="route('list.post')" :active="route().current('list.post')">
                                    Les posts
                                </jet-nav-link>
                                <jet-nav-link :href="route('create.post')" :active="route().current('create.post')">
                                    Creer un post
                                </jet-nav-link>
                                <jet-nav-link :href="route('index.post')" :active="route().current('index.post')">
                                    Mes posts
                                </jet-nav-link>
